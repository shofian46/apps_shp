        ...
        <div class="row justify-content-center">
          <form action="" method="POST" class="col-lg-5 col-md-6 col-sm-12 p-0">
            <div class="card shadow-lg">
              ...
              <div class="card-body">
                <h5 class="card-title">Add New Gudang</h5>
                <p class="card-text">Form to add new gudang to system</p>
                  <?= $this->session->flashdata('message') ?>
                  <div class="form-group">
                    <label for="m_kode_gudang" class="col-form-label-lg">ID Gudang</label>
                    <input type="text" class="form-control form-control-md <?= form_error('m_kode_gudang') ? 'is-invalid': ''; ?>" name="m_kode_gudang" id="m_kode_gudang" value="<?= $gudangid; ?>" readonly>
                    <?= form_error('m_kode_gudang', '<small class="text-danger">', '</small>') ?>
                  </div>
                  <div class="form-group">
                    <label for="m_gudang" class="col-form-label-lg">Gudang</label>
                    <input type="text" class="form-control form-control-md <?= form_error('m_gudang') ? 'is-invalid': ''; ?>" name="m_gudang" id="m_gudang" value="<?= set_value('m_gudang')?>">
